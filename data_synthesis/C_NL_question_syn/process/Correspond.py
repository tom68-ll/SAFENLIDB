...
# Group result dictionary: item_idx -> list of outputs (in order)
...
for item_idx, items in sorted(temp_grouped.items()):
    ...
    db_id = items[0]['db_id']  # db_id should be the same within the group
...
print("Grouped output with db_id and item_id saved to grouped_output.json")